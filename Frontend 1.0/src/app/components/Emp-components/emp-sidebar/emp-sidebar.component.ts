...
{ path: '/emp-asset', title: 'emp-asset',  icon:'design_app', class: '' },
  { path: '/a', title: 'Employees',  icon:'users_single-02', class: '' },
  { path: '/emp/bookAsset', title: 'Book Asset',  icon:'education_atom', class: '' },
